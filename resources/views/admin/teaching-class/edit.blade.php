...
@section('title', 'Admin | Edit Kelas Ajar')
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <h4>Edit Kelas Ajar</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('teaching-class.update', $tc->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tahun_ajar" value="{{ $tc->tahun_ajar }}" id="tahun_ajar" class="form-control @error('tahun_ajar') is-invalid @enderror" placeholder="masukkan tahun ajar">
                            @error('tahun_ajar')
                                <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                            @enderror
                        </div>
